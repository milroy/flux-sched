...
class dfu_impl_t {
   public:
     ...
     *  valid only as an interior waypoint (the request has children); a
     *  non-pooled LEAF request cannot be allocated non-exclusively and is
     *  rejected: nothing would track the share.
     *
