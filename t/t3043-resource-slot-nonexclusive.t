...
# dynamic (first) policy -- 7x5 GB slots pack onto one SSD at 35 GB, and 500 GB
# slots exhaust the four 793 GB SSDs after 4 allocations.
#
...
test_expect_success "${test030_desc}" '
    ...
    test $(grep -c "RESOURCES=ALLOCATED" 030.R.out) -eq 4
'
